...
- сгенерированные ФИО и названия компаний англоязычные, тогда как исходные данные -- русскоязычные; `city` при этом остаётся русским, из-за чего возникает locale-мисматч
